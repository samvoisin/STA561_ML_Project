...
create_label_vec <- function(g) {
  # create a vector of zeros and a single 1 as a data label for gestures
  # 6 possible gestures means vectors will be length 6
  # g is the number of the gesture
  v <- rep(0, 6)
  v[g] <- 1
  return(v)
}
