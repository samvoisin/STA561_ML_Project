...
cvANN <- function(x_dat, y_dat, 
                  pcomp, neurons_per_layer, layers = 1, 
                  out_units, out_met, cvfolds = 5, verb = 0){
...
testNN <- cvANN(x_dat = x_mat, y_dat = y_mat, pcomp = 4, neurons_per_layer = 8, layers = 1,out_units = 6, out_met = c("accuracy"), cvfolds = 5, verb = 0 )
