...
create_results_df = function(cv_ann_out, layers){
  ...
  saveRDS(master_df,file = paste0("4C_ANN_",layers,"_layers.rds"))
  saveRDS(avg_master, file = paste0("4C_CV_AVG_ANN_",layers,"_layers.rds"))
}
...
test = read_rds("4C_CV_AVG_ANN_1_layers.rds")
...
ggsave(file.path(plot_path,"4PC_Avg_CV_ANN_1_layers.png"), dpi = 150, device = "png")
